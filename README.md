...
While it was not required, the instructors recommended using the DAO design pattern as described [here](../main/ProjectRequirements.md).
...
- The *Reports* tab includes 3 tables displaying the required reports outlined in A.3.f. of the [Project Requirements](https://www.tutorialspoint.com/design_pattern/data_access_object_pattern.htm).  
